...
from .identity_resnet import PreActResNet, PreActBlock, Hadamard_Transform, init_sub_identity_conv1x1
...
def construct_model(cfg_model, channels, classes):
    ...
    if 'resnet' in cfg_model.name.lower():
        ...
        #               stem=cfg_model.stem = CIFAR,
        #               nonlin=cfg_model.nonlin_fn = ReLU, norm=cfg_model.normalization = BatchNorm2d,
        #               downsample=cfg_model.downsample = C,
